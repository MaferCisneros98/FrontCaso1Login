...
@Component({
  selector: 'app-reportedenegado',
  templateUrl: './reportedenegado.component.html',
  styleUrls: ['./reportedenegado.component.css']
})
export class ReportedenegadoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.cargarReclamoDenegado();

  }

  cargarReclamoDenegado(): void {
    this.reclamoService.listaDenegado().subscribe(
      data => {
        this.reclamos = data;
      },
      err => {
